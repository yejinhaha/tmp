      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Profile04')
              : const Profile04Widget(),
        ),
        FFRoute(
          name: 'auth_home',
          path: '/authHome',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'auth_home')
        ...
        FFRoute(
          ...
          builder: (context, params) => const ComfirmedPasswordWidget(),
        ),
        FFRoute(
          name: 'edit_profile',
          path: '/editProfile',
        ...
        FFRoute(
          name: 'unity',
          path: '/unity',
          builder: (context, params) => const UnityWidget(),
        ),
        FFRoute(
          name: 'unity_2',
          path: '/unity2',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'unity_2')
              : const Unity2Widget(),
        )
